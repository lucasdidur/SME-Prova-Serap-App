...
mixin _$ProvaRespostaStore on _ProvaRespostaStoreBase, Store {
  ...
  @override
  ObservableMap<int, ProvaResposta> get respostasLocal {
    _$respostasLocalAtom.reportRead();
    return super.respostasLocal;
  }

  @override
  set respostasLocal(ObservableMap<int, ProvaResposta> value) {
  ...
  @override
  Future<void> definirTempoResposta(int questaoId, {int? tempoQuestao}) {
