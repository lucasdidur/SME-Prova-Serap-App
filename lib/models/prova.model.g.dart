...
Prova _$ProvaFromJson(Map<String, dynamic> json) => Prova(
      ...
      idDownload: json['idDownload'] as int?,
...
const _$EnumDownloadStatusEnumMap = {
  EnumDownloadStatus.NAO_INICIADO: 'NAO_INICIADO',
  EnumDownloadStatus.BAIXANDO: 'BAIXANDO',
  EnumDownloadStatus.PAUSADO: 'PAUSADO',
  EnumDownloadStatus.CONCLUIDO: 'CONCLUIDO',
  EnumDownloadStatus.ERRO: 'ERRO',
};
